...
\begin{itemize}
	...
	\item \textbf{boid\_fishes\_variant\_1.bat} - varianta hejna ryb s kolizním objektem sféry \textit{(sphere)}
	\item \textbf{boid\_fishes\_variant\_2sec:spusteni-sceny.bat} - varianta hejna ryb s kolizním objektem kvádru \textit{(cube)}
\end{itemize}
...
\begin{figure}[H]
	\centering
	\subfloat[ Půdorys]{\includegraphics[width=0.43\textwidth]{Figures/map3.jpg}\label{fig:mapatxt}}
	\hfill
	\subfloat[ Patro]{\includegraphics[width=0.43\textwidth]{Figures/map4.jpg}\label{fig:mapatxt}}
...
\begin{figure}[H]\centering\includegraphics[width=0.66\textwidth]{Figures/screen9.jpg}
...
Všechny části testů byly provedeny na schématu budovy s parcelou 30x17 bloků, kdy jeden blok odpovídá jednomu znaku v textovém souboru, ve kterém je definováno schéma budovy, a~na 1x1 blok se vejde průměrně 5~agentů bez větších kolizí.
...
%\begin{figure}[H]
%	\centering
%	\subfloat[Jednodušší labyrint]{\includegraphics[width=0.3\textwidth]{Figures/map5.jpg}\label{fig:mapalabyrinth}}
%	\hfill
%	\subfloat[Složitější labyrint]{\includegraphics[width=0.35\textwidth]{Figures/map6.jpg}\label{fig:mapalabyrinth}}
...
U této simulace nastávají problémy ``cukání'' pokud agent začne vyhodnocovat, že se přiblížil k okraji mapy. Důvod tohoto efektu je aplikování kolize s ostatními agenty a zároveň kolize s~okrajem mapy. Tento problém byl zmírněn při nastavení různých citlivosti jednotlivých pravidel.
...
Nějvětší problémy nastávaly při nastavování konstant jako např: konstanty pro jednotlivá pravidla, kdy při špatném nastavení pohyb agentů neodpovídal realitě.
