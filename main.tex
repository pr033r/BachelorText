...
Následuje vypočtení samotného seek vektoru, který je roven rozdílu mezi požadovanou a aktuální rychlostí. Naposledy pak musíme vektor limitovat konstantou tření \textit{(maxForce)}.
\\
