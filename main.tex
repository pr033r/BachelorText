...
\begin{figure}[H]
	\centering
	\subfloat[ Půdorys]{\includegraphics[width=0.45\textwidth]{Figures/map.jpg}\label{fig:f1}}
	\hfill
	\subfloat[ Patro]{\includegraphics[width=0.45\textwidth]{Figures/map2.jpg}\label{fig:f2}}
